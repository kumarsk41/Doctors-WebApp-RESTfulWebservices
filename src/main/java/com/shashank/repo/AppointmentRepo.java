...
public interface AppointmentRepo extends JpaRepository<Appointments, Integer> {
 ...
 List<Appointments> findByDoctorEmailAndDocBookingDateAndDocBookingTime(
         String doctorEmail, Date docBookingDate, String docBookingTime);

 List<Appointments> findByUserEmailAndDocBookingDateAndDocBookingTimeAndStatus(
         String userEmail, Date docBookingDate, String docBookingTime, String status);
}
